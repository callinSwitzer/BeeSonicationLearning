...
d4 <- melt(d3, id.vars=c("beeCol"), measure.vars=c("full", "full_2", "high", "low" ), value.name = "buzzFreq")
d5 <- melt(d3, id.vars=c("beeCol"), measure.vars=c("full.1", "full_2.1", "high.1", "low.1" ), value.name = "NumBuzzes")
