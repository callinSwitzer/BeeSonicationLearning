...
ggplot(fta, aes(x = trialNum, y = freqDiff, color = t5)) + 
  ...
  theme_classic() + 
  geom_point(aes(x = 1, y = 0), color = 'black' , size = 3, pch  = 18) + 
...
ggsave(filename = file.path(figDir,"freqLearningCurve.pdf"),  width = 6.5*1.5, height = 4*1.5)
