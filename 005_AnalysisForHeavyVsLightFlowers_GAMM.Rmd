...
save_plot(file.path(figDir, "CombinedFreqAmp_weightedSham4_noxlab_IT.pdf"), plot = aa, base_width = 7, base_height = 3)

save_plot(file.path(figDir, "CombinedFreqAmp_weightedSham4_annot_IT.pdf"), plot = ac, base_width = 7, base_height = 3)
