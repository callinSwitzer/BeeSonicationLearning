...
# here
## refref -- make  supplemental plots to show affect of IT span on amplitude and frequency
...
pfreq <- g0_freq + labs(x = "", y = "Sonication frequency (Hz)")

pamp <- g0_amp + labs(x = "")

aa <- plot_grid(pfreq, pamp, align = 'h', axis = 'l', rel_widths = c(1,1.05))

ab <- add_sub(aa, "Flower Treatment", x = 0.53, y = 1, vjust = -0.2)
ggdraw(ab)

ac <- plot_grid(pfreq, pamp, align = 'h', axis = 'l', rel_widths = c(1,1.05), labels = "AUTO")
ad <- add_sub(ac, "Flower Treatment", x = 0.53, y = 1, vjust = -0.2)
ggdraw(ad)


save_plot(file.path(figDir, "CombinedFreqAmp_weightedSham4_noxlab.pdf"), plot = aa, base_width = 5.4, base_height = 3)

save_plot(file.path(figDir, "CombinedFreqAmp_weightedSham4.pdf"), plot = ab, base_width = 5.4, base_height = 3.4)
save_plot(file.path(figDir, "CombinedFreqAmp_weightedSham4_annot.pdf"), plot = ad, base_width = 5.4, base_height = 3.9)
