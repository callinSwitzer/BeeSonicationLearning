...
```{r}
mod1 <- lmer(freq ~ trt2 * visitNum + treatment_rewarded + IT_mm + hive + (1|beeID), REML = FALSE, data = bees)
mod2 <- lmer(freq ~ trt2 + visitNum + treatment_rewarded + IT_mm + hive + (1|beeID), REML = FALSE, data = bees)
