...
ggplot(dd, aes(x = time, y = surv, color = treatment)) + 
  ...
  theme(panel.grid.major = element_line(colour = "grey50", size = 0.1), 
     ...
     theme(legend.title = element_blank(), 
           ...
           legend.position = c(0.76,0.9), legend.background = element_rect(fill = 'grey95'), 
...
ggsave(file.path(figDir, "beeSonicationPercentage_onePlot_twoHives.svg"), width = 8, height = 5)
ggsave(file.path(figDir, "beeSonicationPercentage_onePlot_twoHives.png"), units = "in", dpi = 500, width = 8, height = 5)
