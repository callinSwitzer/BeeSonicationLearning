...
ggplot(newDF2, aes(x=OverallTime_sep,fill=rewardString, group = as.factor(trialNum))) + 
  geom_histogram(data=subset(newDF2,rewardTF==TRUE), aes(y = ..count..),color = 'grey10', lwd = 0.01, binwidth = 50) +
  geom_histogram(data=subset(newDF2,rewardTF==FALSE),aes( y=..count..*(-1)), color = 'grey10', lwd = 0.01, binwidth = 50 ) + 
